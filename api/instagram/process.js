...
import { processBroadcastQueue } from "../../lib/social/broadcast.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const broadcasts = await processBroadcastQueue(100);
    let sync;
    let seed;
    if (req.query.sync === "1") {
    ...
    return sendJson(res, 200, { ok: true, processed, broadcasts, sync, seed });
  } catch (error) {
