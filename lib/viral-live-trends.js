...
export const SOURCES = {
  ...
  "tiktok-tags": {
    ...
    everyMs: 96 * HOUR,
    platforms: ["tiktok"],
    run: apify("clockworks~tiktok-trends-scraper", { adsScrapeHashtags: true, resultsPerPage: MAX_PER_SOURCE, adsCountryCode: "US", adsTimeRange: "7" }, (item) => (item?.name ? `#${String(item.name).replace(/^#/u, "")}` : ""), 0.5),
  },
  instagram: {
